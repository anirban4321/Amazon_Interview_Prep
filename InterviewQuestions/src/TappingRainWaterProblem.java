...
public class TappingRainWaterProblem {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Maximum water that can be accumulated is " + countWaterDrops(arr));
    System.out.println("Maximum water that can be accumulated is " + countWaterDropsWithoutSpace(arr));
